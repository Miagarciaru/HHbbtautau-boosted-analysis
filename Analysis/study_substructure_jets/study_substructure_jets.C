...
void study_substructure_jets(TString sample, TString output_folder, string min_pT){
  ...
  std::ofstream outFile("output_analysis/percentages_ratios.txt", std::ios::app); // Open in append mode
  ...
  outFile << "Matched truth events number is: " << matched_truth_events << endl;
  ...
  outFile << "Number of matched truth-reco Bbb-Btautau events: " << matched_events << "(" << 100.0*matched_events/nentries << "%)" << endl;
  outFile << "Number of matched preselected Bbb-Btautau events: " << matched_preselected_events << "(" << 100.0*matched_preselected_events/nentries << "%)" << endl;
  outFile << "Overlap of truth-reco and preselected Bbb-Btautau events: " << overlap_matched_preselected_events << endl;
  outFile << "Number of matched truth-reco non preselected Bbb-Btautau events: " << matched_non_preselected << endl;
  outFile << "Number of preselected non matched truth reco Bbb-Btautau events: " << preselected_non_matched << endl;

  int sum_BB_preselected = overlap_matched_preselected_events+preselected_non_matched;
  int sum_BB_truth_reco = overlap_matched_preselected_events+matched_non_preselected;
  if(sum_BB_truth_reco!=matched_events || sum_BB_preselected!=matched_preselected_events){
  ...
  int sum_Bbb_preselected = overlap_matched_preselected_bb_events+preselected_bb_non_matched;
  int sum_Bbb_truth_reco = overlap_matched_preselected_bb_events+matched_bb_non_preselected;
  ...
  int sum_Btautau_preselected = overlap_matched_preselected_tautau_events+preselected_tautau_non_matched;
  int sum_Btautau_truth_reco = overlap_matched_preselected_tautau_events+matched_tautau_non_preselected;
