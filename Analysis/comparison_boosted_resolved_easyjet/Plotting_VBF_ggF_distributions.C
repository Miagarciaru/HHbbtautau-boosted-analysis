...
void Plotting_VBF_ggF_distributions(){
  ...
  std::vector<string> comparison_list = {"all_jets_m", "jet12_m", "bb_jet1_pt", "bbtautau_m", "jet12_dR", "tautau_jet1_deta", "bb_jet2_deta", "bb_jet2_dR", "BDT_score", "njets", "bb_m", "tautau_m"}; //"njets"
