...
TH1F *hist_boosted_jet12_m = new TH1F("hist_boosted_jet12_m", "Mass of the two jets j1 and j2; m_(j_{1,2})^{system} [GeV];Events", 30, 0, 3500);
...
TH1F *hist_boosted_jet12_eta = new TH1F("hist_boosted_jet12_eta", "#eta of the two jets j1 and j2; #eta_(j_{1},j_{2})^{system} [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_jet12_phi = new TH1F("hist_boosted_jet12_phi", "#eta of the two jets j1 and j2; #phi_(j_{1},j_{2})^{system} [GeV];Events", 30, 0, 5);
...
TH1F *hist_boosted_bbtautau_m = new TH1F("hist_boosted_bbtautau_m", "Mass of the boosted bb#tau#tau jets system; m_(HH)^{system} [GeV];Events", 30, 0, 2500);
TH1F *hist_boosted_bbtautau_pt = new TH1F("hist_boosted_bbtautau_pt", "pT of boosted bb#tau#tau jets system; p_{T}_(HH)^{system} [GeV];Events", 30, 0, 2000);
TH1F *hist_boosted_bbtautau_eta = new TH1F("hist_boosted_bbtautau_eta", "#eta of the boosted bb#tau#tau jets system; #eta_(HH)^{system} [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_bbtautau_phi = new TH1F("hist_boosted_bbtautau_phi", "#eta of the boosted bb#tau#tau jets system; #phi_(HH)^{system} [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_bbtautau_deta = new TH1F("hist_boosted_bbtautau_deta", "#Delta #eta of the boosted bb and #tau#tau; #Delta #eta(H_{bb},H_{#tau#tau}) [GeV];Events", 30, 0, 4);
TH1F *hist_boosted_bbtautau_dphi = new TH1F("hist_boosted_bbtautau_dphi", "#Delta #eta of the boosted bb and #tau#tau; #Delta #phi(H_{bb},H_{#tau#tau}) [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_bbtautau_dR = new TH1F("hist_boosted_bbtautau_dR", "#Delta #eta of the boosted bb and #tau#tau; #Delta R(H_{bb},H_{#tau#tau}) [GeV];Events", 30, 0, 10);
...
TH1F *hist_boosted_bb_jet1_pt = new TH1F("hist_boosted_bb_jet1_pt", "pT of boosted bb and j1 system; p_{T}_(H_{bb}, j_{1})^{system} [GeV];Events", 30, 0, 2000);
...
TH1F *hist_boosted_bb_jet2_m = new TH1F("hist_boosted_bb_jet2_m", "Mass of the boosted bb and j2 system; m_(H_{bb}, j_{2})^{system} [GeV];Events", 30, 0, 2500);
TH1F *hist_boosted_bb_jet2_pt = new TH1F("hist_boosted_bb_jet2_pt", "pT of boosted bb and j2 system; p_{T}_(H_{bb}, j_{2})^{system} [GeV];Events", 30, 0, 2000);
...
TH1F *hist_boosted_bb_jet2_phi = new TH1F("hist_boosted_bb_jet2_phi", "#eta of the boosted bb and j2 system; #phi_(H_{bb}, j_{2})^{system} [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_bb_jet2_deta = new TH1F("hist_boosted_bb_jet2_deta", "#Delta #eta of the boosted bb and j2; #Delta #eta(H_{bb},j_{2}) [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_bb_jet2_dphi = new TH1F("hist_boosted_bb_jet2_dphi", "#Delta #eta of the boosted bb and j2; #Delta #phi(H_{bb},j_{2}) [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_bb_jet2_dR = new TH1F("hist_boosted_bb_jet2_dR", "#Delta #eta of the boosted bb and j2; #Delta R(H_{bb},j_{2}) [GeV];Events", 30, 0, 10);

// Boosted tautau and jet1 histograms
TH1F *hist_boosted_tautau_jet1_m = new TH1F("hist_boosted_tautau_jet1_m", "Mass of the boosted #tau#tau and j1 system; m_(H_{#tau#tau}, j_{1})^{system} [GeV];Events", 30, 0, 2500);
TH1F *hist_boosted_tautau_jet1_pt = new TH1F("hist_boosted_tautau_jet1_pt", "pT of boosted #tau#tau and j1 system; p_{T}_(H_{#tau#tau}, j_{1})^{system} [GeV];Events", 30, 0, 2000);
TH1F *hist_boosted_tautau_jet1_eta = new TH1F("hist_boosted_tautau_jet1_eta", "#eta of the boosted #tau#tau and j1 system; #eta_(H_{#tau#tau}, j_{1})^{system} [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_tautau_jet1_phi = new TH1F("hist_boosted_tautau_jet1_phi", "#eta of the boosted #tau#tau and j1 system; #phi_(H_{#tau#tau}, j_{1})^{system} [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_tautau_jet1_deta = new TH1F("hist_boosted_tautau_jet1_deta", "#Delta #eta of the boosted #tau#tau and j1; #Delta #eta(H_{#tau#tau},j_{1}) [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_tautau_jet1_dphi = new TH1F("hist_boosted_tautau_jet1_dphi", "#Delta #eta of the boosted #tau#tau and j1; #Delta #phi(H_{#tau#tau},j_{1}) [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_tautau_jet1_dR = new TH1F("hist_boosted_tautau_jet1_dR", "#Delta #eta of the boosted #tau#tau and j1; #Delta R(H_{#tau#tau},j_{1}) [GeV];Events", 30, 0, 10);

// Boosted tautau and jet2 histograms
TH1F *hist_boosted_tautau_jet2_m = new TH1F("hist_boosted_tautau_jet2_m", "Mass of the boosted #tau#tau and j2 system; m_(H_{#tau#tau}, j_{2})^{system} [GeV];Events", 30, 0, 2500);
TH1F *hist_boosted_tautau_jet2_pt = new TH1F("hist_boosted_tautau_jet2_pt", "pT of boosted #tau#tau and j2 system; p_{T}_(H_{#tau#tau}, j_{2})^{system} [GeV];Events", 30, 0, 2000);
TH1F *hist_boosted_tautau_jet2_eta = new TH1F("hist_boosted_tautau_jet2_eta", "#eta of the boosted #tau#tau and j2 system; #eta_(H_{#tau#tau}, j_{2})^{system} [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_tautau_jet2_phi = new TH1F("hist_boosted_tautau_jet2_phi", "#eta of the boosted #tau#tau and j2 system; #phi_(H_{#tau#tau}, j_{2})^{system} [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_tautau_jet2_deta = new TH1F("hist_boosted_tautau_jet2_deta", "#Delta #eta of the boosted #tau#tau and j2; #Delta #eta(H_{#tau#tau},j_{2}) [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_tautau_jet2_dphi = new TH1F("hist_boosted_tautau_jet2_dphi", "#Delta #eta of the boosted #tau#tau and j2; #Delta #phi(H_{#tau#tau},j_{2}) [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_tautau_jet2_dR = new TH1F("hist_boosted_tautau_jet2_dR", "#Delta #eta of the boosted #tau#tau and j2; #Delta R(H_{#tau#tau},j_{2}) [GeV];Events", 30, 0, 10);

// All jets system variables
TH1F *hist_boosted_all_jets_m = new TH1F("hist_boosted_all_jets_m", "Mass of the boosted jets system; m_(HH, j_{1}, j_{2})^{system} [GeV];Events", 30, 0, 4500);
TH1F *hist_boosted_all_jets_pt = new TH1F("hist_boosted_all_jets_pt", "pT of boosted jets system; p_{T}_(HH, j_{1}, j_{2})^{system} [GeV];Events", 30, 0, 2000);
TH1F *hist_boosted_all_jets_eta = new TH1F("hist_boosted_all_jets_eta", "#eta of the boosted jets system; #eta_(HH, j_{1}, j_{2})^{system} [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_all_jets_phi = new TH1F("hist_boosted_all_jets_phi", "#eta of the boosted jets system; #phi_(HH, j_{1}, j_{2})^{system} [GeV];Events", 30, 0, 5);
TH1F *hist_boosted_all_jets_deta = new TH1F("hist_boosted_all_jets_deta", "#Delta #eta of the boosted bb#tau#tau and j12; #Delta #eta(H_{bb#tau#tau},j_{12}) [GeV];Events", 30, 0, 10);
TH1F *hist_boosted_all_jets_dphi = new TH1F("hist_boosted_all_jets_dphi", "#Delta #eta of the boosted bb#tau#tau and j12; #Delta #phi(H_{bb#tau#tau},j_{12}) [GeV];Events", 30, 0, 5);
