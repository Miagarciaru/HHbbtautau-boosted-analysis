...
df_bb_jets = functions.get_df_with_info_jets(df_events, features_to_keep, "idx_b1truth_recoak10_dRmin")
df_tautau_jets = functions.get_df_with_info_jets(df_events, features_to_keep, "idx_tau1truth_recoak10_dRmin")
